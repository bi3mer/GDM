...
# ##### Value Iteration
# value_iteration_lambda = lambda G, _: RL.value_iteration(G, N, GAMMA, THETA)
...
# in_place_value_iteration_lambda = lambda G, _: RL.value_iteration(G, N, GAMMA, THETA, in_place=True)
...
# ##### Policy Iteration
# policy_iteration_lambda = lambda G, _: RL.policy_iteration(G, GAMMA)
...
# in_place_policy_iteration_lambda = lambda G, _: RL.policy_iteration(G, GAMMA, in_place=True)
...
# modified_policy_iteration_lambda = lambda G, _: RL.policy_iteration(G, GAMMA, modified=True)
...
# modified_in_place_policy_iteration_lambda = lambda G, _: RL.policy_iteration(G, GAMMA, in_place=True, modified=True)
